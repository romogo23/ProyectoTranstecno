<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CloseBill.aspx.cs" Inherits="UI.CloseBill" %>
    ...
    <form id="form1" runat="server" class="formImage">
        <div class="container">
            <div class="AdminFormBill">
                <h1 class="titleAdmin">Cerrar Factura:</h1>
                <div class="formlabels">
                    ...
                    <br />
                    <asp:TextBox ID="txtIdPaymentMethod" runat="server" CssClass="form-control"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="reqPaymentMethod" runat="server" ControlToValidate="txtIdPaymentMethod" ErrorMessage="Debe ingresar un identificador de metodo de pago"></asp:RequiredFieldValidator>
                    <br />
                    <br />
                    ...
                    <asp:RequiredFieldValidator ID="reqPaymentDate" runat="server" ControlToValidate="txtPaymentDate" ErrorMessage="Debe ingresar una fecha de pago"></asp:RequiredFieldValidator>
                </div>
