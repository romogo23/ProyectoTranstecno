<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CloseInvoice.aspx.cs" Inherits="UI.CloseInvoice" %>
    ...
    <form id="form1" runat="server">
        <div>
            <div>
                ...
                <br />
                <asp:TextBox ID="txtIdPaymentMethod" runat="server"></asp:TextBox>
