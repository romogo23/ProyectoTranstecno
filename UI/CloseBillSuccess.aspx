<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CloseBillSuccess.aspx.cs" Inherits="UI.CloseBillSuccess" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Cerrar Factura Exito</title>
...
<body>
    ...
    <form id="form1" runat="server" class="formConf">
        <div class="formLabels">
            ...
            <div class="textBlock">
                <asp:Label ID="Label1" runat="server" Text="Factura cerrada exitosamente"></asp:Label>
            </div>
        </div>
    </form>
